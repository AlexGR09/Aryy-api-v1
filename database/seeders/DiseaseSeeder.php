...
class DiseaseSeeder extends Seeder
{
    ...
    public function run()
    {
        \DB::table('diseases')->insert([
            ...
            //Oncólogo médico
            ['inicio' => 'Abetalipoproteinemia'],
            ['inicio' => 'Adenocarcinoma de las células renales'],
            ['inicio' => 'Adenocarcinoma del estómago'],
            ['inicio' => 'Adenocarcinoma del útero'],
            ['inicio' => 'Androblastoma'],
            ['inicio' => 'Arrenoblastoma'],
            ['inicio' => 'Arrenoblastoma del ovario'],
            ['inicio' => 'Astrocitoma en niños'],
            ['inicio' => 'Cambios precancerosos del cuello uterino'],
            ['inicio' => 'Cáncer'],
            ['inicio' => 'Cáncer colorrectal'],
            ['inicio' => 'Cáncer de cabeza y cuello'],
            ['inicio' => 'Cáncer de células escamosas de la piel'],
            ['inicio' => 'Cáncer de células transicionales de la pelvis renal o del uréter'],
            ['inicio' => 'Cáncer de garganta'],
            ['inicio' => 'Cáncer de la vulva'],
            ['inicio' => 'Cáncer de las vías biliares'],
            ['inicio' => 'Cáncer de los ovarios'],
            ['inicio' => 'Cáncer de mama'],
            ['inicio' => 'Cáncer de paratiroides'],
            ['inicio' => 'Cáncer de pene'],
            ['inicio' => 'Cáncer de piel'],
            ['inicio' => 'Cáncer de piel en célula basal'],
            ['inicio' => 'Cáncer de piel escamocelular'],
            ['inicio' => 'Cáncer de próstata'],
            ['inicio' => 'Cáncer de pulmón'],
            ['inicio' => 'Cáncer de pulmón de células no pequeñas'],
            ['inicio' => 'Cáncer de pulmón de células pequeñas'],
            ['inicio' => 'Cáncer de retina'],
            ['inicio' => 'Cáncer de testículos'],
            ['inicio' => 'Cáncer de testículos'],
            ['inicio' => 'Cáncer de tiroides'],
            ['inicio' => 'Cáncer de útero'],
            ['inicio' => 'Cáncer de vagina'],
            ['inicio' => 'Cáncer de vejiga'],
            ['inicio' => 'Cáncer del colon'],
            ['inicio' => 'Cáncer del cuello uterino'],
            ['inicio' => 'Cáncer del estómago'],
            ['inicio' => 'Cáncer del hígado'],
            ['inicio' => 'Cáncer del páncreas'],
            ['inicio' => 'Cáncer endometrial'],
            ['inicio' => 'Cáncer escamocelular del pene'],
            ['inicio' => 'Cáncer laríngeo'],
            ['inicio' => 'Cáncer metastásico al pulmón'],
            ['inicio' => 'Cáncer no Hodgkin'],
            ['inicio' => 'Cáncer oral'],
            ['inicio' => 'Cáncer peniano'],
            ['inicio' => 'Cáncer renal'],
            ['inicio' => 'Cáncer testicular'],
            ['inicio' => 'Cáncer testicular seminoma'],
            ['inicio' => 'Cáncer: leucemia infantil aguda (LLA)'],
            ['inicio' => 'CAP'],
            ['inicio' => 'Carcinoma'],
            ['inicio' => 'Carcinoma anaplásico de tiroides'],
            ['inicio' => 'Carcinoma broncopulmonar'],
            ['inicio' => 'Carcinoma bucal de células escamosas'],
            ['inicio' => 'Carcinoma corticosuprarrenal'],
            ['inicio' => 'Carcinoma de células renales'],
            ['inicio' => 'Carcinoma de células transicionales de la vejiga'],
            ['inicio' => 'Carcinoma ductal o canalicular'],
            ['inicio' => 'Carcinoma escamocelular de la piel'],
            ['inicio' => 'Carcinoma hepatocelular'],
            ['inicio' => 'Carcinoma lobulillar'],
            ['inicio' => 'Carcinoma medular de tiroides'],
            ['inicio' => 'Carcinoma microcítico de pulmón'],
            ['inicio' => 'Carcinoma paratiroideo'],
            ['inicio' => 'Carcinoma posterior de la lengua'],
            ['inicio' => 'Carcinoma primario de las células del hígado'],
            ['inicio' => 'Carcinomas amicrocíticos de pulmón'],
            ['inicio' => 'Carcinomas broncopulmonares no microcíticos'],
            ['inicio' => 'CML'],
            ['inicio' => 'Colangiocarcinoma'],
            ['inicio' => 'Colestasis extrahepática'],
            ['inicio' => 'Colestasis intrahepática'],
            ['inicio' => 'Corioblastoma'],
            ['inicio' => 'Coriocarcinoma'],
            ['inicio' => 'Corioepitelioma'],
            ['inicio' => 'Craneofaringioma'],
            ['inicio' => 'Desnutrición maligna'],
            ['inicio' => 'Dolor oncológico'],
            ['inicio' => 'EICH'],
            ['inicio' => 'Émbolo tumoral'],
            ['inicio' => 'Enfermedad injerto contra huésped'],
            ['inicio' => 'Enfermedades terminales'],
            ['inicio' => 'Enteritis por radiación'],
            ['inicio' => 'Enteropatía por radiación'],
            ['inicio' => 'Ependimoma en adultos'],
            ['inicio' => 'Ependimoma en niños'],
            ['inicio' => 'Eritroplasia de Queyrat'],
            ['inicio' => 'Familia de tumores de Ewing'],
            ['inicio' => 'Ganglioneuroblastoma'],
            ['inicio' => 'Glucagonoma'],
            ['inicio' => 'Hipernefroma'],
            ['inicio' => 'Incidentaloma de tiroides'],
            ['inicio' => 'Leiomiosarcoma'],
            ['inicio' => 'Leishmaniasis'],
            ['inicio' => 'Leucemia'],
            ['inicio' => 'Leucemia aguda granulocítica'],
            ['inicio' => 'Leucemia aguda mieloide'],
            ['inicio' => 'Leucemia crónica granulocítica'],
            ['inicio' => 'Leucemia linfocítica aguda'],
            ['inicio' => 'Leucemia mielógena crónica (LMC)'],
            ['inicio' => 'Leucemia no linfocítica aguda'],
            ['inicio' => 'Linfoma cerebral'],
            ['inicio' => 'Linfoma de alto grado de células B'],
            ['inicio' => 'Linfoma de Hodgkin'],
            ['inicio' => 'Linfoma de las células B'],
            ['inicio' => 'Linfoma histiocítico'],
            ['inicio' => 'Linfoma linfoblástico'],
            ['inicio' => 'Linfoma linfocítico'],
            ['inicio' => 'Linfoma linfoplasmacítico'],
            ['inicio' => 'Linfoma mediastinal'],
            ['inicio' => 'LLA'],
            ['inicio' => 'LLC'],
            ['inicio' => 'LMA'],
            ['inicio' => 'LMC'],
            ['inicio' => 'Macroglobulinemia primaria'],
            ['inicio' => 'Meduloblastoma en adultos'],
            ['inicio' => 'Melanoma'],
            ['inicio' => 'Melanoma maligno de la coroides'],
            ['inicio' => 'Melanoma metastásico'],
            ['inicio' => 'Meningioma en adultos'],
            ['inicio' => 'Mesotelioma maligno'],
            ['inicio' => 'Metaplasia mielocitoide agnógena'],
            ['inicio' => 'Metaplasia mieloide'],
            ['inicio' => 'Metástasis a los pulmones'],
            ['inicio' => 'Metástasis cerebral'],
            ['inicio' => 'Metástasis de hígado'],
            ['inicio' => 'Metástasis ósea'],
            ['inicio' => 'Mielofibrosis'],
            ['inicio' => 'Mielofibrosis idiopática'],
            ['inicio' => 'Mielofibrosis primaria'],
            ['inicio' => 'Mieloma de células plasmáticas'],
            ['inicio' => 'MTC'],
            ['inicio' => 'Nefroblastoma'],
            ['inicio' => 'Neoplasia'],
            ['inicio' => 'Neoplasia trofoblástica gestacional'],
            ['inicio' => 'Neurofibromatosis 2'],
            ['inicio' => 'Neurofibromatosis acústica bilateral'],
            ['inicio' => 'Neuroglioma en adultos'],
            ['inicio' => 'Neuroma acústico'],
            ['inicio' => 'NF acústica bilateral central'],
            ['inicio' => 'NF2'],
            ['inicio' => 'Oligodendroglioma en adultos'],
            ['inicio' => 'Osteosarcoma'],
            ['inicio' => 'Plasmacitoma del hueso'],
            ['inicio' => 'Plasmacitoma maligno'],
            ['inicio' => 'Prolactinoma'],
            ['inicio' => 'Pseudotumor cerebral'],
            ['inicio' => 'Rabdomiosarcoma'],
            ['inicio' => 'Rabdomiosarcoma alveolar'],
            ['inicio' => 'Rabdomiosarcoma embrionario'],
            ['inicio' => 'Sarcoma botrioides'],
            ['inicio' => 'Sarcoma de Ewing'],
            ['inicio' => 'Sarcoma de Kaposi'],
            ['inicio' => 'Sarcoma de partes blandas'],
            ['inicio' => 'Sarcoma del tejido blando'],
            ['inicio' => 'Sarcoma osteógeno'],
            ['inicio' => 'SCLC'],
            ['inicio' => 'Secreción ectópica de hormona antidiurética'],
            ['inicio' => 'Seudotumor orbital'],
            ['inicio' => 'Síndrome carcinoide'],
            ['inicio' => 'Síndrome de Cushing ectópico'],
            ['inicio' => 'Síndrome de Cushing yatrógeno'],
            ['inicio' => 'Síndrome de Gorlin'],
            ['inicio' => 'Síndrome de Peutz-Jeghers'],
            ['inicio' => 'Síndrome del carcinoma basocelular nevoide'],
            ['inicio' => 'Síndrome del cayado aórtico'],
            ['inicio' => 'SPJ'],
            ['inicio' => 'Teratoma inmaduro'],
            ['inicio' => 'Teratoma maligno'],
            ['inicio' => 'Teratoma: tumor de células germinales no seminomatosas'],
            ['inicio' => 'Timoma mediastinal'],
            ['inicio' => 'Trastornos renales y urológicos'],
            ['inicio' => 'Trombocitosis esencial'],
            ['inicio' => 'Tumor'],
            ['inicio' => 'Tumor cerebral canceroso (metastásico)'],
            ['inicio' => 'Tumor cerebral infratentorial'],
            ['inicio' => 'Tumor cerebral metastásico (secundario)'],
            ['inicio' => 'Tumor de células de Leydig'],
            ['inicio' => 'Tumor de células de los islotes o tumor de células insulares'],
            ['inicio' => 'Tumor de células de los islotes pancreáticos'],
            ['inicio' => 'Tumor de células germinativas'],
            ['inicio' => 'Tumor de la fosa posterior'],
            ['inicio' => 'Tumor de la glándula lagrimal'],
            ['inicio' => 'Tumor de la médula espinal'],
            ['inicio' => 'Tumor de los cordones sexuales'],
            ['inicio' => 'Tumor de los islotes de Langerhans'],
            ['inicio' => 'Tumor de retina'],
            ['inicio' => 'Tumor de Wilms'],
            ['inicio' => 'Tumor del ángulo'],
            ['inicio' => 'Tumor del ángulo pontocerebeloso'],
            ['inicio' => 'Tumor del glomo timpánico'],
            ['inicio' => 'Tumor del hígado'],
            ['inicio' => 'Tumor del hueso temporal'],
            ['inicio' => 'Tumor del nervio de Jacobson'],
            ['inicio' => 'Tumor del parto'],
            ['inicio' => 'Tumor en el conducto salival'],
            ['inicio' => 'Tumor endocrino pancreático'],
            ['inicio' => 'Tumor estromático'],
            ['inicio' => 'Tumor estromático gonadal'],
            ['inicio' => 'Tumor fibroso localizado de la pleura'],
            ['inicio' => 'Tumor glómico yugular'],
            ['inicio' => 'Tumor hipofisario'],
            ['inicio' => 'Tumor hipotalámico'],
            ['inicio' => 'Tumor maligno'],
            ['inicio' => 'Tumor mediastinal'],
            ['inicio' => 'Tumor medular'],
            ['inicio' => 'Tumor metastásico de la pleura'],
            ['inicio' => 'Tumor nasal benigno'],
            ['inicio' => 'Tumor ocular'],
            ['inicio' => 'Tumor productor de péptido intestinal vasoactivo'],
            ['inicio' => 'Tumor suprarrenal'],
            ['inicio' => 'Tumor testicular'],
            ['inicio' => 'Tumor tiroideo'],
            ['inicio' => 'Tumor trofoblástico'],
            ['inicio' => 'Tumor vaginal'],
            ['inicio' => 'Tumores neuroectodérmicos primitivos'],
            ['inicio' => 'Tumores o protuberancias en las mamas'],
            ['inicio' => 'TVP'],
            ['inicio' => 'Úlcera roedora'],
            ['inicio' => 'Vipoma'],
            ...
            //Psiquiatra y Psiquiatra infantil
